...
class ObjectCategory
{
    ...
    obj_type_map = {
        ...
        moving_car:                   {color: '#ff00ff', size: [1.9, 4.6, 1.5], attr: []},
        moving_truck:                 {color: '#ff8c00', size: [2.5, 10.0, 3.2], attr: []},
        static_truck:                 {color: '#ff1493', size: [2.5, 10.0, 3.2], attr: []},
        moving_bus:                   {color: '#ffd700', size: [2.9, 12.0, 3.4], attr: []},
        static_bus:                   {color: '#808000', size: [2.9, 12.0, 3.4], attr: []},
        moving_cyclist:               {color: '#00ffff', size: [0.6, 1.7, 1.5], attr: []},
        static_cyclist:               {color: '#6600cc', size: [0.6, 1.7, 1.5], attr: []},
        moving_construction_vehicle:  {color: '#ff1493', size: [2.6, 6.5, 3.0], attr: []},
        static_construction_vehicle:  {color: '#c71585', size: [2.6, 6.5, 3.0], attr: []},
        moving_other_vehicle:         {color: '#8a2be2', size: [2.0, 5.0, 2.0], attr: []},
        static_other_vehicle:         {color: '#4b0082', size: [2.0, 5.0, 2.0], attr: []},
